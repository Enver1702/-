...
Console.WriteLine($"{minSumLine+1} - the line with the smallest sum ({sumLine}) of elements ");
...
*/
/*
Console.WriteLine($"Enter the dimensions of the matrices and the range of random valuesй: ");
...
int b = InputNumbers("Enter the number of columns of the 2nd matrix: ");
...
*/
/*
Console.WriteLine($"Enter the size of the array A x B x C:");
int a = InputNumbers("Enter A ");
int b = InputNumbers("Enter B: ");
int c = InputNumbers("Enter C: ");
Console.WriteLine($"");
